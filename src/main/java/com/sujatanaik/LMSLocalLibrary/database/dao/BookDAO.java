...
public interface BookDAO extends JpaRepository<Book, Long> {
    ...
    @Query(value = "SELECT * FROM books WHERE title LIKE %:title% AND bstatus = 'CHECKEDOUT'", nativeQuery = true)
    List<Book> findBookByTitleAndCheckedOut(@Param("title") String title);
}
